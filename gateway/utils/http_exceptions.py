...
This module provides helper functions for raising HTTP exceptions
with consistent status codes and messages.
"""
...
def raise_internal_error(
    detail: str = "Internal server error. Please try again later or contact the administrator."
) -> NoReturn:
...
def raise_insufficient_quota(
    detail: str = "Insufficient quota. Please recharge your account."
) -> NoReturn:
...
def raise_payload_too_large(
    detail: str = "Request payload is too large."
) -> NoReturn:
    """Raises an HTTP 413 Request Entity Too Large exception."""
    raise HTTPException(status_code=HTTP_413_REQUEST_ENTITY_TOO_LARGE, detail=detail)
